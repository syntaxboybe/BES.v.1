   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
         ...
         {{-- <li class="nav-item active">
            <p class="nav-link text-white text-center" id="nav_bar_display">Welcome, {{session("user.username")}}</p>
         </li> --}}

         <li class="nav-item active">
            <a class="nav-link text-white text-center" id="firstname_topnav" href="#"> Welcome, {{session("user.username")}} <span class="sr-only">(current)</span></a>
         </li>
