...
<body style="background-image: url({{ URL::asset('images/na1vbg.png') }}); background-repeat: repeat; background-size: cover ">
                    ...
                    <div class="card-body">
                        ...
                        <form class="log-in-form" action="login" method="post">
                            ...
                            <div class="form-label-group mt-2">
                                ...
                                <input type="text" id="login_username" name="login_username" class="form-control" placeholder="Username" autofocus value={{ old('login_username')}}>
                                @error('login_email')
