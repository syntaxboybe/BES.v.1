...
<div class="col-sm-12 text-left ">
    <h1 class="border-bottom border-bot pt-3">Certificate Issuance</h1>
</div>
<div class="main-wrapper col-sm-12 text-left h-100  pr-0 pl-0 ">
    <div class="col-sm-12 pl-0 pr-0 search-bars">
        ...
        <div class="tab-nav ">
            ...
            <button class="tablinks" onclick="schedules(event, 'schedule') ">Layout</button>
                        ...
                        <div class="row">
                            <div class="col-md-12 order-md-1  pt-4">
                                <form class="needs-validation" name="certform" id="certform" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        <label>Barangay Logo Background: Dimension: MAX:500px</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="punongbarangay" type="file" class="form-control" class="text-center" required="" id="logo2" name="logo2" style="padding: 0px !important">
                                        <div class="invalid-feedback">
                                            Invalid Logo or no image
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="municipality" name="municipality" value="{{ $layout->municipality ?? ''  }}" required="" placeholder="Ex: MUNICIPALITY OF NAAWAN">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="province" name="province" value="{{ $layout->province ?? ''  }}" placeholder="Ex: PROVINCE OF MISAMIS ORIENTAL" required="">
                                        <div class="invalid-feedback">
                                            Input Field Required
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="barangay" name="barangay" value="{{ $layout->barangay ?? ''  }}" placeholder="Ex: BARANGAY POBLACION" required="">
                                        <div class="invalid-feedback">
                                            Input Field Required
                                        </div>
                                    </div>
                ...
                <div class="col-sm-6 border solid overflow-auto">
                    <div class="row">
                        <div class="column-right text-right">
                            <img src="{{ URL::asset('images/poblacionlogo.png') }}" style="resize: both;width: 100px;margin-right: 30px;">
                        </div>
                        <div class="column-center text-center">
                            <p id="heading" style='font-size:12px;font-family: "Times New Roman, Times, serif";'> Republic of the Philippines<br>
                                {{ $layout->municipality ?? 'Municipality of Naawan'  }}<br>
                                {{ $layout->province ?? 'Province of Misamis Oriental'  }}<br>
                                {{ $layout->barangay ?? 'Barangay Poblacion'  }}
                                <br> -o0o- <br />
                                <u>==================================================================</u>
                            </p>
                            <div id="punong" style='font-size:22px;font-family: "Times New Roman, Times, serif";padding:0px'><b>{{ $layout->office ?? 'Office of the Punong Barangay'  }}</b>
                            </div>
                        ...
                        <div class="column-left text-left">
                            <img src="{{ URL::asset('images/municipallogo.png') }}" style="resize: both;width: 100px;margin-right: 30px;">
                        </div>
                    </div>
                    <div class="box">
                        <img id="logobackground1" src="{{ URL::asset('images/poblacionlogo.png') }}" class="background-opacity text-center" style="height: 450px;margin-left: 30%;margin-top: 40px;">
                        <div class="row text">


                        </div>
                    </div>
                    <div class="column-body-center " style="padding-left:5px">
                        <br>
                        <br>
                        <br>
                        <br>
            ...
            <div class="modal-body">
                ...
                <form id="certtypeform" name="certtypeform" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <textarea id="content_1" required name="content_1" rows="5" style=" width:100%;" placeholder="Ex: Barangay Poblacion. He/She is personally known to me of good moral..."></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" required class="form-control" id="content_3" name="content_3" placeholder="Ex: Barangay Poblacion, Naaawan" value="" maxlength="50" required="">
