                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            <option value="Registry of Barangay Inhabitants">Registry of Barangay Inhabitants</option>
                  ...
                  <form class="needs-validation" novalidate="" action="{{ route('image.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <input  class="form-control" id="name" name="barangay_name" value="{{ $Barangayimage->barangay_name ?? '' }}" placeholder="Ex: Barangay Burnay">
                        <div class="invalid-feedback">
                     ...
                     <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="city" name="city" value="{{ $Barangayimage->city ?? '' }}"placeholder="Ex: Cagayan De Oro" required="">
                        <div class="invalid-feedback">
                           Input Field Required
                        </div>
                     </div>
                     <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="province" value="{{ $Barangayimage->province ?? '' }}" name="province" placeholder="Ex: Misamis Oriental" required="">
                        <div class="invalid-feedback">
                           Input Field Required
                        </div>
                     </div>
