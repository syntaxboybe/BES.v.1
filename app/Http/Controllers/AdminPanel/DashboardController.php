...
class DashboardController extends Controller
{
    public function dashboard()
    {
        ...
        $nonvoter = DB::table('resident_infos')
            ->where('voterstatus','=','No')->count();

        return view('pages.AdminPanel.dashboard',['brgy_official'=>$brgy_official,'area_setting'=>$area_setting,
        'male'=>$male,'female'=>$female,'voter'=>$voter,'registered'=>$registered, 'nonvoter'=>$nonvoter,'certificate_requests'=>$certificate_requests]);
    }
}
