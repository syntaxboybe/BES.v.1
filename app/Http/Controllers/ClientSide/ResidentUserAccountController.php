...
class ResidentUserAccountController extends Controller
{
    ...
    public function client_check(Request $request){
        ...
        $validator = Validator::make($request->all(), [
            "client_login_username" => ["required"],
            "client_login_password" => ["required", new ResidentConfirmPassword($request->client_login_username)]
        ],
        [
            "client_login_username.required" => "Enter your username!!!",
            "client_login_password.required" => "Enter your password!!!"
        ])->validate();

        $resident = resident_account::where("username","=", $request->client_login_username)->first();
